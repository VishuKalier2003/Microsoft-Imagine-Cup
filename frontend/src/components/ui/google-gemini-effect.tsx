...
export const GoogleGeminiEffect = ({
    ...
    return (
        <div className={cn("sticky top-20 w-full flex flex-col items-center justify-center overflow-hidden", className)}>
            <div className="relative z-10 w-full pt-20 md:pt-40">
          ...
          works!`}
                ...
                <div className="w-full h-[400px] flex items-center justify-center relative mt-10">
                    <button className="font-bold bg-white rounded-full md:px-6 md:py-3 px-4 py-2 z-30 md:text-base text-black text-xs w-fit mx-auto transition-transform hover:scale-105">
                        Get Started
                    </button>
                </div>
            </div>
            ...
            <div className="absolute inset-0 w-full h-full flex items-center justify-center pointer-events-none">
                <svg
                    ...
                    className="w-full max-w-[1440px] h-auto opacity-50"
