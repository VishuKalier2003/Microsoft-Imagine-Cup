...
export function FeaturesSection() {
    return (
        <section className="bg-gray-50 py-16 md:py-32 dark:bg-transparent" id="why-us">
            <div className="mx-auto max-w-3xl lg:max-w-5xl px-6">
                <div className="relative">
                    <div className="relative z-10 grid grid-cols-6 gap-3">
                        <Card className="relative col-span-full flex overflow-hidden lg:col-span-2 bg-zinc-950 border-white/10 text-white">
                        ...
                        <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2 bg-zinc-950 border-white/10 text-white">
                            <CardContent className="pt-6">
                                ...
                                <div className="relative z-10 mt-6 space-y-2 text-center">
                                    ...
                                    <p className="text-white/60">
                                        Advanced encryption protecting your health records.
                                    </p>
                                </div>
                            </CardContent>
                        </Card>
                        <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2 bg-zinc-950 border-white/10 text-white">
                            <CardContent className="pt-6">
                                ...
                                <div className="relative z-10 mt-14 space-y-2 text-center">
                                    ...
                                    <p className="text-white/60">
                                        Instant AI analysis and health predictions.
                                    </p>
                                </div>
                            </CardContent>
                        </Card>
                        <Card className="relative col-span-full overflow-hidden lg:col-span-3 bg-zinc-950 border-white/10 text-white">
                            <CardContent className="grid pt-6 sm:grid-cols-2">
                                ...
                                <div className="rounded-tl-3xl relative -mb-6 -mr-6 mt-6 h-fit border-l border-t border-white/10 p-6 py-6 sm:ml-6">
                            ...
                            <CardContent className="grid h-full pt-6 sm:grid-cols-2">
                                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <p className="text-white/60">
                                            Share your status with family to keep them connected.
                                        </p>
                                    </div>
                                </div>
                                <div className="before:bg-white/10 relative mt-6 before:absolute before:inset-0 before:mx-auto before:w-px sm:-my-6 sm:-mr-6">
                                    <div className="relative flex h-full flex-col justify-center space-y-6 py-6">
                                        <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                                            <span className="block h-fit rounded border border-white/10 px-2 py-1 text-xs shadow-sm bg-zinc-900">
                                                Family
                                            </span>
                                            <div className="ring-background size-7 ring-4 border border-white/10 rounded-full">
                                                <img
